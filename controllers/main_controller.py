...
class MainController(QObject):
    operation_completed = pyqtSignal(bool, str)
    financial_analysis_completed = pyqtSignal(dict)  # Nouveau signal pour les résultats financiers
    ...
    def __init__(self):
        ...
        self.file_controller = FileController(self)
        self.export_controller = ExportController(self)
        self.tab_controller = TabController(self)  # Initialisation du contrôleur d'onglet

        # Connecter les signaux
        self.model.data_updated.connect(lambda: self.operation_completed.emit(True, "Données mises à jour"))

        # Connecter le signal de calcul des ratios financiers
        self.tab_controller.financial_model.calculation_complete.connect(
    ...
    def _handle_financial_results(self, results):
        ...
        # Ici vous pouvez aussi mettre à jour votre modèle principal si nécessaire
    ...
    def get_financial_tab_view(self):
         return self.tab_controller.get_view()

    def calculate_financial_ratios(self, data):
         self.tab_controller.financial_model.update_data(data)
        return self.tab_controller.calculate_ratios()"""
